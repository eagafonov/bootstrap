...
BOOTSTRAP_RESPONSIVE_NS = ./docs/assets/css/bootstrap-responsive-ns.css
BOOTSTRAP_RESPONSIVE_NS_LESS = ./less/responsive-ns.less
...
build:
	...
	@./node_modules/.bin/recess --compile ${BOOTSTRAP_NS_LESS} > ${BOOTSTRAP_NS}
	@./node_modules/.bin/recess --compile ${BOOTSTRAP_NS_RESPONSIVE_LESS} > ${BOOTSTRAP_RESPONSIVE_NS}
...
bootstrap/css/*.css: less/*.less
	...
	./node_modules/.bin/recess --compile ${BOOTSTRAP_NS_LESS} > bootstrap/css/bootstrap-ns.css
	./node_modules/.bin/recess --compress ${BOOTSTRAP_NS_LESS} > bootstrap/css/bootstrap-ns.min.css
	./node_modules/.bin/recess --compile ${BOOTSTRAP_NS_RESPONSIVE_LESS} > bootstrap/css/bootstrap-responsive-ns.css
	./node_modules/.bin/recess --compress ${BOOTSTRAP_NS_RESPONSIVE_LESS} > bootstrap/css/bootstrap-responsive-ns.min.css
